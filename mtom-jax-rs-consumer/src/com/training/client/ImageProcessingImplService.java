 ...
 * 
 */
@WebServiceClient(name = "ImageProcessingImplService", targetNamespace = "http://services.training.com/", wsdlLocation = "http://localhost:7070/images?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7070/images?wsdl");
